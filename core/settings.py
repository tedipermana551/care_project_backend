...
CSRF_TRUSTED_ORIGINS = [h for h in os.environ.get('CSRF_TRUSTED_ORIGINS', '').split(',') if h.strip()]
...
if os.environ.get('USE_R2') == 'True':
    ...
    AWS_S3_CUSTOM_DOMAIN  = os.environ.get('R2_CUSTOM_DOMAIN')  # pub-xxx.r2.dev (no https://)
